...
class PageDemoVC: UIPageViewController {
    ...
    class func create() -> PageDemoVC {
        let vc = UIStoryboard(name: Constants.SBID.SB.Misc, bundle: nil).instantiateViewController(withIdentifier: Constants.SBID.VC.PageDemo) as! PageDemoVC
        return vc
    }
...
//        }
    ...
    func setupContinueButton() {
        ...
        continueButton.configure(title: "got it", systemImage: "")
...
extension PageDemoVC: UIPageViewControllerDelegate, UIScrollViewDelegate {
